                ...
                <div class="container-xl">
                    <div class="row g-2 align-items-center">
                        <div class="col">
                            ...
                            <h1 class="page-title">Combo layout</h1>
                        </div>
                        <!-- Page title actions -->
                ...
                <div class="container-xl">
                    <div class="row row-deck row-cards">
                                ...
                                <div class="card-body">
                                    <div class="row gy-3">
                                        <div class="col-12 col-sm d-flex flex-column">
                                            ...
                                            <p class="text-secondary">You have 5 new messages and 2 new notifications.
                                            </p>
                                            <div class="row g-5 mt-auto">
                                                ...
                                                <div class="col-auto">
                                                    ...
                                                    <div class="progress progress-sm">
                                                        <div class="progress-bar bg-danger" style="width: 78%"
                                                            role="progressbar" aria-valuenow="78" aria-valuemin="0"
                                                            aria-valuemax="100" aria-label="78% Complete">
                                        ...
                                        <div class="col-12 col-sm-auto d-flex justify-content-center">
                                            <a href="./illustrations.html">
                                                <svg xmlns="http://www.w3.org/2000/svg" height="200" fill="none"
                                                    viewBox="0 0 800 600">
                                                    ...
                                                    <path
                                                        ...
                                                        fill="#066FD1"
                                                        style="fill: #066fd1; fill: var(--tblr-illustrations-primary, var(--tblr-primary, #066fd1))"
                                                        opacity="0.02" class="tblr-illustrations-good-info-a" />
                                                    <path
                                                    ...
                                                    <path
                                                        ...
                                                        fill="#D6D8E2" opacity="0.5"
                                                        class="tblr-illustrations-good-info-b" />
                                                    <path
                                                    ...
                                                    <path
                                                        ...
                                                        fill="#232B41" class="tblr-illustrations-good-info-c" />
                                                    <path
                                                    ...
                                                    <path
                                                        ...
                                                        fill="black" opacity="0.1" />
                                                    <path
                                                        d="M437.797 352.334L452.376 349.28L453.745 353.049L441.263 361.023L437.797 352.334Z"
                                                        fill="#DADCE0" />
                                                    <path
                                                        d="M437.291 352.115L425.063 334.094L419.73 335.997L424.59 355.86L437.291 352.115Z"
                                                        fill="#DADCE0" />
                                                    <path
                                                        d="M437.797 352.334L452.376 349.28L453.745 353.049L441.263 361.023L437.797 352.334Z"
                                        ...
                                        <div class="me-auto">
                                            <span class="text-green d-inline-flex align-items-center lh-1">
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    ...
                                                    aria-hidden="true" focusable="false" class="icon ms-0 icon-sm">
                                                    <path d="M12 5l0 14" />
                                                    <path d="M18 11l-6 -6" />
                                                    <path d="M6 11l6 -6" />
                                                </svg>
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-auto lh-1">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end"
                                                    aria-labelledby="revenue-dropdown">
                                                    <a class="dropdown-item active" href="#" aria-current="true">Last 7
                                                        days</a>
                                                    <a class="dropdown-item" href="#">Last 30 days</a>
                                                    <a class="dropdown-item" href="#">Last 3 months</a>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-auto lh-1">
                                            <div class="dropdown">
                                                <a class="dropdown-toggle text-secondary" id="new-clients-dropdown"
                                                    href="#" data-bs-toggle="dropdown" aria-haspopup="true"
                                                    aria-expanded="false"
                                                    aria-label="Select time range for new clients">Last 7 days</a>
                                                <div class="dropdown-menu dropdown-menu-end"
                                                    aria-labelledby="new-clients-dropdown">
                                                    <a class="dropdown-item active" href="#" aria-current="true">Last 7
                                                        days</a>
                                                    <a class="dropdown-item" href="#">Last 30 days</a>
                                                    <a class="dropdown-item" href="#">Last 3 months</a>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-auto lh-1">
                                            <div class="dropdown">
                                                <a class="dropdown-toggle text-secondary" id="active-users-dropdown"
                                                    href="#" data-bs-toggle="dropdown" aria-haspopup="true"
                                                    aria-expanded="false"
                                    ...
                                    <div class="card card-sm">
                                        <div class="card-body">
                                            <div class="row align-items-center">
                                                <div class="col-auto">
                                                    <span
                                                        class="bg-primary text-white avatar avatar-square"><!-- Download SVG icon from http://tabler.io/icons/icon/currency-dollar -->
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                            viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    ...
                                    <div class="card card-sm">
                                        <div class="card-body">
                                            <div class="row align-items-center">
                                                <div class="col-auto">
                                                    <span
                                                        class="bg-green text-white avatar avatar-square"><!-- Download SVG icon from http://tabler.io/icons/icon/shopping-cart -->
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                            viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                            stroke-width="2" stroke-linecap="round"
                                                            stroke-linejoin="round" aria-hidden="true" focusable="false"
                                    ...
                                    <div class="card card-sm">
                                        <div class="card-body">
                                            <div class="row align-items-center">
                                                <div class="col-auto">
                                                    <span
                                                        class="bg-x text-white avatar avatar-square"><!-- Download SVG icon from http://tabler.io/icons/icon/brand-x -->
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                            viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                            stroke-width="2" stroke-linecap="round"
                                                            stroke-linejoin="round" aria-hidden="true" focusable="false"
                                    ...
                                    <div class="card card-sm">
                                        <div class="card-body">
                                            <div class="row align-items-center">
                                                <div class="col-auto">
                                                    <span
                                                        class="bg-facebook text-white avatar avatar-square"><!-- Download SVG icon from http://tabler.io/icons/icon/brand-facebook -->
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                            viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                            stroke-width="2" stroke-linecap="round"
                                                            stroke-linejoin="round" aria-hidden="true" focusable="false"
                                            ...
                                            <div class="divide-y">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col">
                                                            <div class="text-truncate">
                                                                ...
                                                                <strong>Not everything is what it seems</strong>
                                                            </div>
                                                ...
                                                <div>
                                                    <div class="row">
                                                        ...
                                                        <div class="col">
                                                            <div class="text-truncate">It's <strong>Mallory
                                                                    Hulme</strong>'s birthday today</div>
                                                ...
                                                <div>
                                                    <div class="row">
                                                        ...
                                                        <div class="col">
                                                            <div class="text-truncate">
                                                                <strong>Dunn Slane</strong> posted a status:
                                                                <strong>Trying to figure things out one step at a
                                                                    time.</strong>
                                                            </div>
                                                            <div class="text-secondary">now</div>
                                                        </div>
                                                ...
                                                <div>
                                                    <div class="row">
                                                        ...
                                                        <div class="col">
                                                            <div class="text-truncate"><strong>Emmy Levet</strong>
                                                                created a new project: <strong>Smart Morning
                                                                    Alarm</strong></div>
                                                ...
                                                <div>
                                                    <div class="row">
                                                        ...
                                                        <div class="col">
                                                            <div class="text-truncate"><strong>Maryjo Lebarree</strong>
                                                                liked your photo</div>
                                                            <div class="text-secondary">now</div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div>
                                                    <div class="row">
                                                        ...
                                                        <div class="col">
                                                            <div class="text-truncate"><strong>Egan Poetz</strong>
                                                                registered a new client: <strong>Trilia
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col">
                                                            <div class="text-truncate">
                                                                ...
                                                                project: <strong>PPAP Campaign Strategy</strong>
                                                            </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col">
                                                            <div class="text-truncate">
                                                                ...
                                                                project: <strong>Wikibox Knowledge Platform</strong>
                                                            </div>
                                                            <div class="text-secondary">4 days ago</div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div>
                                                    <div class="row">
                                                        ...
                                                        <div class="col">
                                                            <div class="text-truncate">
                                                                <strong>Haskel Shelper</strong> changed project status
                                                ...
                                                <div>
                                                    <div class="row">
                                                        ...
                                                        <div class="col">
                                                            <div class="text-truncate"><strong>Lorry Mion</strong> liked
                                                                the <strong>Tabler UI Kit</strong></div>
                                                            <div class="text-secondary">now</div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div>
                                                    <div class="row">
                                                        ...
                                                        <div class="col">
                                                            <div class="text-truncate"><strong>Leesa Beaty</strong>
                                                                shared a new video: <strong>Design Tips for Busy
                                                                    Creators</strong></div>
                                                            <div class="text-secondary">2 days ago</div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div>
                                                    <div class="row">
                                                        <div class="col-auto">
                                                            <span class="avatar avatar-1"
                                                                style="background-image: url(./static/avatars/007m.jpg)">
                                                            </span>
                                                        </div>
                                                        <div class="col">
                                                            <div class="text-truncate"><strong>Perren Keemar</strong>
                                                                and <strong>3 others</strong> followed you</div>
                                                            <div class="text-secondary">now</div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div>
                                                    <div class="row">
                                                        ...
                                                        <div class="col">
                                                            <div class="text-truncate">
                                                                <strong>Sunny Airey</strong> uploaded <strong>3 new
                                                                    photos</strong> to category: <strong>Creative
                                                                    Inspirations</strong>
                                                            </div>
                                                            <div class="text-secondary">2 days ago</div>
                                                        </div>
                                                ...
                                                <div>
                                                    <div class="row">
                                                        <div class="col-auto">
                                                            <span class="avatar avatar-1"
                                                                style="background-image: url(./static/avatars/009m.jpg)">
                                                            </span>
                                                        </div>
                                                        <div class="col">
                                                            <div class="text-truncate"><strong>Geoffry
                                                                    Flaunders</strong> made a <strong>$10
                                                                    donation</strong></div>
                                                            <div class="text-secondary">2 days ago</div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div>
                                                    <div class="row">
                                                        ...
                                                        <div class="col">
                                                            <div class="text-truncate"><strong>Thatcher Keel</strong>
                                                                created a profile</div>
                                                ...
                                                <div>
                                                    <div class="row">
                                                        <div class="col-auto">
                                                            <span class="avatar avatar-1"
                                                                style="background-image: url(./static/avatars/005f.jpg)">
                                                            </span>
                                                        </div>
                                                        <div class="col">
                                                            <div class="text-truncate"><strong>Dyann Escala</strong>
                                                                hosted the event: <strong>Tabler UI Anniversary</strong>
                                                            </div>
                                                            <div class="text-secondary">4 days ago</div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div>
                                                    <div class="row">
                                                        <div class="col-auto">
                                                            <span class="avatar avatar-1"
                                                                style="background-image: url(./static/avatars/006f.jpg)">
                                                            </span>
                                                        </div>
                                                        <div class="col">
                                                            <div class="text-truncate"><strong>Avivah Mugleston</strong>
                                                                mentioned you in <strong>Best of 2020
                                                ...
                                                <div>
                                                    <div class="row">
                                                        ...
                                                        <div class="col">
                                                            <div class="text-truncate"><strong>Arlie Armstead</strong>
                                                                sent a review request to <strong>Amanda Blake</strong>
                                                            </div>
                                                            <div class="text-secondary">2 days ago</div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div>
                                                    <div class="row">
                                                        ...
                                                        <div class="col">
                                                            <div class="text-truncate"><strong>Tessie Curzon</strong>
                                                                posted a photo from her vacation in
                                                ...
                                                <div>
                                                    <div class="row">
                                                        <div class="col-auto">
                                                            <span class="avatar avatar-1"
                                                                style="background-image: url(./static/avatars/009f.jpg)">
                                                            </span>
                                                        </div>
                                                        <div class="col">
                                                            <div class="text-truncate"><strong>Flossi Uttley</strong>
                                                                shared an article: <strong>Top 10 productivity
                                                                    hacks</strong></div>
                                                            <div class="text-secondary">now</div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div>
                                                    <div class="row">
                                                        <div class="col-auto">
                                                            <span class="avatar avatar-1"
                                                                style="background-image: url(./static/avatars/010f.jpg)">
                                                            </span>
                                                        </div>
                                                        <div class="col">
                                                            <div class="text-truncate"><strong>Cesya Spritt</strong>
                                                ...
                                                <div>
                                                    <div class="row">
                                                        <div class="col-auto">
                                                            <span class="avatar avatar-1"
                                                                style="background-image: url(./static/avatars/011m.jpg)">
                                                            </span>
                                                        </div>
                                                        <div class="col">
                                                            <div class="text-truncate"><strong>Johnnie Gilby</strong>
                                                                joined the group: <strong>UX Designers Hub</strong>
                                                            </div>
                                                            <div class="text-secondary">now</div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div>
                                                    <div class="row">
                                                        <div class="col-auto">
                                                            <span class="avatar avatar-1"
                                                                style="background-image: url(./static/avatars/012m.jpg)">
                                                            </span>
                                                        </div>
                                                        <div class="col">
                                                            <div class="text-truncate"><strong>Ban Rzehor</strong>
                                                                uploaded new design mockups</div>
                                                            <div class="text-secondary">now</div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div>
                                                    <div class="row">
                                                        <div class="col-auto">
                                                            <span class="avatar avatar-1"
                                                                style="background-image: url(./static/avatars/011f.jpg)">
                                                            </span>
                                                        </div>
                                                        <div class="col">
                                                            <div class="text-truncate"><strong>Carroll Erat</strong>
                                                                reacted with ❤️ to your story</div>
                                                            <div class="text-secondary">3 days ago</div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div>
                                                    <div class="row">
                                                        <div class="col-auto">
                                                            <span class="avatar avatar-1"
                                                                style="background-image: url(./static/avatars/012f.jpg)">
                                                            </span>
                                                        </div>
                                                        <div class="col">
                                                            <div class="text-truncate"><strong>Marsha Labat</strong>
                                                                posted a video: <strong>Building Better
                                                                    Dashboards</strong></div>
                                                            <div class="text-secondary">3 days ago</div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div>
                                                    <div class="row">
                                                        <div class="col-auto">
                                                            <span class="avatar avatar-1"
                                                                style="background-image: url(./static/avatars/013m.jpg)">
                                                            </span>
                                                        </div>
                                                        <div class="col">
                                                            <div class="text-truncate"><strong>Elston Muffett</strong>
                                                                joined your webinar: <strong>Intro to
                                                ...
                                                <div>
                                                    <div class="row">
                                                        <div class="col-auto">
                                                            <span class="avatar avatar-1"
                                                                style="background-image: url(./static/avatars/013f.jpg)">
                                                            </span>
                                                        </div>
                                                        <div class="col">
                                                            <div class="text-truncate"><strong>Leigha Gorce</strong>
                                                                commented: <strong>This is so helpful!</strong></div>
                                                            <div class="text-secondary">4 days ago</div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div>
                                                    <div class="row">
                                                        <div class="col-auto">
                                                            <span class="avatar avatar-1"> TB </span>
                                                        </div>
                                                        <div class="col">
                                                            <div class="text-truncate"><strong>Tallie Bettis</strong>
                                                                updated her profile photo</div>
                                                            <div class="text-secondary">3 days ago</div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div>
                                                    <div class="row">
                                                        ...
                                                        <div class="col">
                                                            <div class="text-truncate"><strong>Merrily Garforth</strong>
                                                                posted a job listing: <strong>Frontend
                                                ...
                                                <div>
                                                    <div class="row">
                                                        <div class="col-auto">
                                                            <span class="avatar avatar-1"> EB </span>
                                                        </div>
                                                        <div class="col">
                                                            <div class="text-truncate">
                                                                <strong>Errol Blackley</strong> started following your
                                                                project: <strong>Clean Code Patterns</strong>
                                                            </div>
                                                            <div class="text-secondary">now</div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div>
                                                    <div class="row">
                                                        ...
                                                        <div class="col">
                                                            <div class="text-truncate"><strong>Ninon Don</strong> gave
                                                                feedback on your latest design</div>
                                                            <div class="text-secondary">now</div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div>
                                                    <div class="row">
                                                        <div class="col-auto">
                                                            <span class="avatar avatar-1"
                                                                style="background-image: url(./static/avatars/015m.jpg)">
                                                            </span>
                                                        </div>
                                                        <div class="col">
                                                            <div class="text-truncate"><strong>Delaney Cairney</strong>
                                                                shared a playlist: <strong>Coding Flow</strong></div>
                                                            <div class="text-secondary">4 days ago</div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div>
                                                    <div class="row">
                                                        <div class="col-auto">
                                                            <span class="avatar avatar-1"
                                                                style="background-image: url(./static/avatars/017f.jpg)">
                                                            </span>
                                                        </div>
                                                        <div class="col">
                                                            <div class="text-truncate"><strong>Gratia Gooley</strong>
                                                                joined the event: <strong>Night UI Meetup</strong></div>
                                                            <div class="text-secondary">now</div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div>
                                                    <div class="row">
                                                        ...
                                                        <div class="col">
                                                            <div class="text-truncate"><strong>Odelinda McCosh</strong>
                                                                shared a memory: <strong>2 years at Tabler!</strong>
                                                            </div>
                                                            <div class="text-secondary">3 days ago</div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div>
                                                    <div class="row">
                                                        <div class="col-auto">
                                                            <span class="avatar avatar-1"
                                                                style="background-image: url(./static/avatars/016m.jpg)">
                                                            </span>
                                                        </div>
                                                        <div class="col">
                                                            <div class="text-truncate"><strong>Wilburt
                                                                    Siegertsz</strong> retweeted your latest post</div>
                                                            <div class="text-secondary">now</div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div>
                                                    <div class="row">
                                                        <div class="col-auto">
                                                            <span class="avatar avatar-1"
                                                                style="background-image: url(./static/avatars/019f.jpg)">
                                                            </span>
                                                        </div>
                                                        <div class="col">
                                                            <div class="text-truncate"><strong>Julietta Coke</strong>
                                                                shared your story to their network</div>
                                                            <div class="text-secondary">3 days ago</div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div>
                                                    <div class="row">
                                                        <div class="col-auto">
                                                            <span class="avatar avatar-1"
                                                                style="background-image: url(./static/avatars/017m.jpg)">
                                                            </span>
                                                        </div>
                                                        <div class="col">
                                                            <div class="text-truncate"><strong>Portie Christou</strong>
                                                                invited you to collaborate on her workspace</div>
                                                            <div class="text-secondary">now</div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div>
                                                    <div class="row">
                                                        <div class="col-auto">
                                                            <span class="avatar avatar-1"
                                                                style="background-image: url(./static/avatars/018m.jpg)">
                                                            </span>
                                                        </div>
                                                        <div class="col">
                                                            <div class="text-truncate"><strong>Emmott Dowsett</strong>
                                                                published a new blog post: <strong>Dark Mode for
                                                                    All</strong></div>
                                                            <div class="text-secondary">2 days ago</div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div>
                                                    <div class="row">
                                                        <div class="col-auto">
                                                            <span class="avatar avatar-1"
                                                                style="background-image: url(./static/avatars/019m.jpg)">
                                                            </span>
                                                        </div>
                                                        <div class="col">
                                                            <div class="text-truncate"><strong>Rooney Cassy</strong>
                                                                mentioned you in a comment</div>
                                                            <div class="text-secondary">now</div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div>
                                                    <div class="row">
                                                        ...
                                                        <div class="col">
                                                            <div class="text-truncate"><strong>Haze Hubbert</strong>
                                                                shared a new design: <strong>Modern Dashboard
                                                                    UI</strong></div>
                                                            <div class="text-secondary">now</div>
                                                        </div>
                                                    </div>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="td-truncate">
                                                    <div class="text-truncate">Fix dart Sass compatibility (#29755)
                                                    </div>
                                                </td>
                                                <td class="text-nowrap text-secondary">28 Nov 2025</td>
                                            </tr>
                                            <tr>
                                                <td class="w-1">
                                                    <span class="avatar avatar-sm"
                                                ...
                                                <td class="td-truncate">
                                                    <div class="text-truncate">Change deprecated html tags to text
                                                        decoration classes (#29604)</div>
                                                </td>
                                                <td class="text-nowrap text-secondary">27 Nov 2025</td>
                                            </tr>
                                            <tr>
                                                <td class="w-1">
                                                    <span class="avatar avatar-sm"
                                                ...
                                                <td class="text-nowrap text-secondary">26 Nov 2025</td>
                                            </tr>
                                            <tr>
                                                <td class="w-1">
                                                    <span class="avatar avatar-sm"
                                            ...
                                            <tr>
                                                ...
                                                <td class="td-truncate">
                                                    <div class="text-truncate">Regenerate package-lock.json (#29730)
                                                    </div>
                                                </td>
                                                <td class="text-nowrap text-secondary">25 Nov 2025</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                                        ...
                                        <div class="col-10">
                                            ...
                                            <div class="markdown">
                                                ...
                                                <a href="https://tabler.io/icons" target="_blank" rel="noopener">Tabler
                                                    Icons Website</a>, download any of the 5986 icons in SVG, PNG
                                                or&nbsp;React and use them in your favourite design tools.
                                            </div>
                                            <div class="mt-3">
                                                <a href="https://tabler.io/icons" class="btn btn-primary"
                        ...
                        <div class="col-md-6 col-lg-4">
                            <a href="https://github.com/sponsors/codecalm" class="card border-primary" target="_blank"
                                rel="noopener" aria-label="Sponsor Tabler!"
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 480 373"
                                    class="position-absolute top-0 right-0 bottom-0 left-0 w-100 h-100">
                                    ...
                                    <path stroke="var(--tblr-primary)" opacity=".3" stroke-miterlimit="10"
                                        stroke-width="2"
                                        d="M37 42c5.523 0 10-4.477 10-10s-4.477-10-10-10-10 4.477-10 10 4.477 10 10 10Z" />
                                    <path stroke="var(--tblr-primary)" opacity=".5" stroke-miterlimit="10"
                                        stroke-width="2"
                                        d="M416.2 360a7.5 7.5 0 1 0 0-15 7.5 7.5 0 0 0 0 15ZM113.7 28.5V46m-8.8-8.8h17.5" />
                                    <path stroke="var(--tblr-primary)" opacity=".2" stroke-miterlimit="10"
                                        stroke-width="1.692"
                                        d="m230.1 328.4 3.9-7.1 3.9 7.1 7.1 3.9-7.1 3.9-3.9 7.1-3.9-7.1-7.1-3.9 7.1-3.9Z" />
                                    <path stroke="var(--tblr-primary)" opacity=".1" stroke-miterlimit="10"
                                        stroke-width="2"
                                        d="m434.5 117 3.3-6.2 3.4 6.2 6.1 3.3-6.1 3.4-3.4 6.1-3.3-6.1-6.2-3.4 6.2-3.3Z" />
                                    <path stroke="var(--tblr-primary)" opacity=".4" stroke-miterlimit="10"
                                        stroke-width="2"
                                    ...
                                    <path fill="#8D5548" stroke="#000" stroke-miterlimit="10" stroke-opacity=".2"
                                        stroke-width=".372"
                                            ...
                                            <div class="mt-4">
                                                <button class="btn w-100 pe-none" type="button">
                                                    ...
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                        ...
                                                        focusable="false" class="icon text-pink icon-3">
                                                        <path
